...
public class TestIsFinished {
	...
	public void IsFinished()
	{
		...
		s3.Add(new Stone(5, Stone.StoneColor.Green, false));
		s3.Add(new Stone(5, Stone.StoneColor.Green, false));
		s3.Add(new Stone(5, Stone.StoneColor.Green, false));
		s3.Add(new Stone(5, Stone.StoneColor.Green, false));
		s3.Add(new Stone(13, Stone.StoneColor.Blue, false));
		s3.Add(new Stone(1, Stone.StoneColor.Blue, false));
		s3.Add(new Stone(2, Stone.StoneColor.Blue, false));
		s3.Add(new Stone(3, Stone.StoneColor.Blue, false));
		s3.Add(new Stone(4, Stone.StoneColor.Red, false));
		s3.Add(new Stone(5, Stone.StoneColor.Red, false));
		s3.Add(new Stone(6, Stone.StoneColor.Red, false));
		s3.Add(new Stone(7, Stone.StoneColor.Red, false));
		s3.Add(new Stone(8, Stone.StoneColor.Red, false));
		s3.Add(new Stone(9, Stone.StoneColor.Red, false));
		//..
